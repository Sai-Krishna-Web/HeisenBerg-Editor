working demo can be checked here [Demo](https://focused-hamilton-ebc2d1.netlify.app).
...
React : UI Components
DraftsJs:  Editor functionalty
Auth0: Login and user authentication
npm & yarn: node modules package manager
